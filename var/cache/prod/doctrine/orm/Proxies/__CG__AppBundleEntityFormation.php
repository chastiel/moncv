 ...
 */
class Formation extends \AppBundle\Entity\Formation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Formation' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Formation' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Formation' . "\0" . 'dateDebut', '' . "\0" . 'AppBundle\\Entity\\Formation' . "\0" . 'dateFin', '' . "\0" . 'AppBundle\\Entity\\Formation' . "\0" . 'lieu'];
        }
